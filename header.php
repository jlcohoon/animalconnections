			...
			<div class="container">
				<nav id="site-navigation" class="navbar navbar-default" role="navigation">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" id="animal-connections" href="<?php echo esc_url( home_url() ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
							<img src="/wp-content/themes/farben-basic/library/images/dog.png" id="site-logo">
							<?php bloginfo( 'name' ); ?>
